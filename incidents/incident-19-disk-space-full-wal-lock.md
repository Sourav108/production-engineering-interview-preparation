# Incident Scenario: PostgreSQL Disk Full from Unpurged WAL Archive Segments

**Category**: Disk Full | **Severity**: Sev-1 | **Target Level**: Staff / Senior Production Engineer
...
- **14:14**: Diagnostic investigation isolated root cause (disk full).
...
2. *Hypothesis B (Disk Full)*: Tested via telemetry queries $	o$ **CONFIRMED**.
...
## 10. Root Cause
Resource contention in disk full crossed non-linear saturation thresholds under peak concurrency, queueing in-flight worker threads.
