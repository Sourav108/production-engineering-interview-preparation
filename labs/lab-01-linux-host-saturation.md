# Lab LAB-01: Linux Host CPU Saturation & PSI Triage

**Primary Tooling**: stress-ng | **Domain**: Linux Kernel & PSI | **Target Level**: Staff / Senior SRE
...
Simulate a severe production degradation in linux kernel & psi where client p99 latency spikes and error budgets burn.
...
Key interview concept: explain how this hands-on lab proves the mathematical difference between naive mitigation and systemic architectural isolation in linux kernel & psi.
