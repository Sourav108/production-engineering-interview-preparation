# Lab LAB-02: JVM Memory Leak & Heap Dump Forensics

**Primary Tooling**: Java 21 + Eclipse MAT | **Domain**: Memory Leaks | **Target Level**: Staff / Senior SRE
...
Simulate a severe production degradation in memory leaks where client p99 latency spikes and error budgets burn.
...
Key interview concept: explain how this hands-on lab proves the mathematical difference between naive mitigation and systemic architectural isolation in memory leaks.
