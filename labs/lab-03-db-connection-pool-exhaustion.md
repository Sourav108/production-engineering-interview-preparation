# Lab LAB-03: HikariCP Connection Pool Exhaustion & PgBouncer

**Primary Tooling**: PostgreSQL 16 + HikariCP | **Domain**: Connection Pools | **Target Level**: Staff / Senior SRE
...
Simulate a severe production degradation in connection pools where client p99 latency spikes and error budgets burn.
...
Key interview concept: explain how this hands-on lab proves the mathematical difference between naive mitigation and systemic architectural isolation in connection pools.
