# Lab LAB-04: OpenTelemetry Tracing & Tail Latency Analysis

**Primary Tooling**: OpenTelemetry Collector + Jaeger | **Domain**: Distributed Tracing | **Target Level**: Staff / Senior SRE
...
Simulate a severe production degradation in distributed tracing where client p99 latency spikes and error budgets burn.
...
Key interview concept: explain how this hands-on lab proves the mathematical difference between naive mitigation and systemic architectural isolation in distributed tracing.
