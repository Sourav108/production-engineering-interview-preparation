# Lab LAB-05: Prometheus Multi-Window Multi-Burn Rate Alerting

**Primary Tooling**: Prometheus + Alertmanager | **Domain**: SLO Alerting | **Target Level**: Staff / Senior SRE
...
Simulate a severe production degradation in slo alerting where client p99 latency spikes and error budgets burn.
...
Key interview concept: explain how this hands-on lab proves the mathematical difference between naive mitigation and systemic architectural isolation in slo alerting.
