# Lab LAB-06: Decomposing Latency Bottlenecks with k6 & Grafana

**Primary Tooling**: k6 + Spring Boot | **Domain**: Latency Decomposition | **Target Level**: Staff / Senior SRE
...
Simulate a severe production degradation in latency decomposition where client p99 latency spikes and error budgets burn.
...
Key interview concept: explain how this hands-on lab proves the mathematical difference between naive mitigation and systemic architectural isolation in latency decomposition.
