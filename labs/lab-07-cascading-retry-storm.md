# Lab LAB-07: Simulating & Breaking a Cascading Retry Storm

**Primary Tooling**: Go Microservices + WireMock | **Domain**: Retry Storms | **Target Level**: Staff / Senior SRE
...
Simulate a severe production degradation in retry storms where client p99 latency spikes and error budgets burn.
...
Key interview concept: explain how this hands-on lab proves the mathematical difference between naive mitigation and systemic architectural isolation in retry storms.
