# Lab LAB-08: Resilience4j Circuit Breaker & Fallback Pipeline

**Primary Tooling**: Resilience4j + Java | **Domain**: Circuit Breakers | **Target Level**: Staff / Senior SRE
...
Simulate a severe production degradation in circuit breakers where client p99 latency spikes and error budgets burn.
...
Key interview concept: explain how this hands-on lab proves the mathematical difference between naive mitigation and systemic architectural isolation in circuit breakers.
