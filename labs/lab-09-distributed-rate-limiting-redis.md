# Lab LAB-09: Distributed Rate Limiting with Atomic Redis Lua

**Primary Tooling**: Redis 7 + NGINX | **Domain**: Rate Limiting | **Target Level**: Staff / Senior SRE
...
Simulate a severe production degradation in rate limiting where client p99 latency spikes and error budgets burn.
...
Key interview concept: explain how this hands-on lab proves the mathematical difference between naive mitigation and systemic architectural isolation in rate limiting.
