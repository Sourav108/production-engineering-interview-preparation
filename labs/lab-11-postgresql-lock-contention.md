# Lab LAB-11: Diagnosing & Resolving PostgreSQL Lock Queues

**Primary Tooling**: PostgreSQL 16 | **Domain**: DB Lock Contention | **Target Level**: Staff / Senior SRE
...
Simulate a severe production degradation in db lock contention where client p99 latency spikes and error budgets burn.
...
Key interview concept: explain how this hands-on lab proves the mathematical difference between naive mitigation and systemic architectural isolation in db lock contention.
