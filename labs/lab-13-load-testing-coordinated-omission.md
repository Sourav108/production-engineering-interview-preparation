# Lab LAB-13: Eliminating Coordinated Omission in k6 Benchmarks

**Primary Tooling**: k6 + Grafana | **Domain**: Honest Benchmarking | **Target Level**: Staff / Senior SRE
...
Simulate a severe production degradation in honest benchmarking where client p99 latency spikes and error budgets burn.
...
Key interview concept: explain how this hands-on lab proves the mathematical difference between naive mitigation and systemic architectural isolation in honest benchmarking.
