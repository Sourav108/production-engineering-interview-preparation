# Lab LAB-14: Automated Canary Rollouts with Metric Analysis

**Primary Tooling**: Kubernetes + Argo Rollouts | **Domain**: Canary Rollouts | **Target Level**: Staff / Senior SRE
...
Simulate a severe production degradation in canary rollouts where client p99 latency spikes and error budgets burn.
...
Key interview concept: explain how this hands-on lab proves the mathematical difference between naive mitigation and systemic architectural isolation in canary rollouts.
