# Lab LAB-15: Running a Production GameDay Simulation Drill

**Primary Tooling**: GameDay CLI Simulator | **Domain**: GameDay & Postmortem | **Target Level**: Staff / Senior SRE
...
Simulate a severe production degradation in gameday & postmortem where client p99 latency spikes and error budgets burn.
...
Key interview concept: explain how this hands-on lab proves the mathematical difference between naive mitigation and systemic architectural isolation in gameday & postmortem.
