# Project: Resilient Microservices Platform with Circuit Breakers & Ingress

**Tech Stack**: Docker Compose / Minikube, Resilience4j, Redis, OpenTelemetry | **Target Level**: Staff / Senior Production Engineer
...
## 3. Technology Stack
- **Core**: Docker Compose / Minikube, Resilience4j, Redis, OpenTelemetry
