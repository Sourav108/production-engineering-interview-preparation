# Project: Complete Production Observability Stack (OTel, Prometheus, Jaeger, Loki)

**Tech Stack**: OpenTelemetry Collector, Prometheus, Jaeger, Grafana | **Target Level**: Staff / Senior Production Engineer
...
## 3. Technology Stack
- **Core**: OpenTelemetry Collector, Prometheus, Jaeger, Grafana
