# Project: Automated Canary Deployment Pipeline with Metric Analysis & Auto-Rollback

**Tech Stack**: Kubernetes, Argo Rollouts, Prometheus, Kayenta | **Target Level**: Staff / Senior Production Engineer
...
## 3. Technology Stack
- **Core**: Kubernetes, Argo Rollouts, Prometheus, Kayenta
