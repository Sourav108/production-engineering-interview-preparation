# Project: SLO-Driven Multi-Window Multi-Burn Rate Alerting & Policy Engine

**Tech Stack**: Prometheus, Alertmanager, Python, Slack API | **Target Level**: Staff / Senior Production Engineer
...
## 3. Technology Stack
- **Core**: Prometheus, Alertmanager, Python, Slack API
