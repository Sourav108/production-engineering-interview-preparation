# Project: Multi-Region Active-Active Disaster Recovery & Consensus Simulation

**Tech Stack**: CockroachDB, Anycast DNS, Docker Compose, Terraform | **Target Level**: Staff / Senior Production Engineer
...
## 3. Technology Stack
- **Core**: CockroachDB, Anycast DNS, Docker Compose, Terraform
