# Project: Self-Healing Kubernetes Custom Controller with Safety Guardrails

**Tech Stack**: Go (Kubebuilder), Kubernetes API, Prometheus Client | **Target Level**: Staff / Senior Production Engineer
...
## 3. Technology Stack
- **Core**: Go (Kubebuilder), Kubernetes API, Prometheus Client
